  ...
  return (
    <div className="min-h-screen bg-hero flex items-center justify-center p-4 relative overflow-hidden">
      <div className="absolute inset-0 opacity-20">
        <div className="absolute bottom-1/3 right-1/4 w-80 h-80 bg-teal/20 rounded-full blur-[120px]" />
      </div>
      <motion.div
      ...
      >
        <div className="rounded-2xl bg-card border border-border shadow-card-hover p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground mt-1">Start verifying videos today</p>
          </div>
